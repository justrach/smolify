/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: ef72a960bd1a29a3c0492d0ab336a0cf)
// Runtime types generated with workerd@1.20260714.1 2026-07-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DOCS: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	SMOLIFY_ROOT_DOMAIN: "smol.ly";
	BETTER_AUTH_URL: "https://app.smol.ly";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SMOLIFY_ROOT_DOMAIN" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET">> {}
}
